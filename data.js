const menuGoods = [
    {
        id: '1',
        img: './images/menu/meat.png',
        name: 'Мясная Делюкс',
        ingredients: ['Пепперони', 'лук', 'бекон', 'томатная паста', 'колбаски', 'переце', 'грибы', 'соус', 'чили', 'анансы']
    },
    {
        id: '2',
        img: './images/menu/sea.png',
        name: 'Морская Премиум',
        ingredients: ['Перец', 'сыр', 'креветки', 'кальмары', 'мидии', 'лосось']
    },
    {
        id: '3',
        img: './images/menu/bacon.png',
        name: 'Бекон и Сосиски',
        ingredients: ['Бекон', 'сыр', 'сосиски', 'ананас', 'томатная паста']
    },
    {
        id: '4',
        img: './images/menu/chicken.png',
        name: 'Куриная Делюкс',
        ingredients: ['Курица', 'ананас', 'сыр Пепперони',  'соус для пиццы', 'томатная паста']
    },
    {
        id: '5',
        img: './images/menu/barbecue.png',
